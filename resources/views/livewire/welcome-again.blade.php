<div>
    ...
    <div
        ...
        class="">
        <div class="">
            <div class="md:max-w-5xl grid md:py-12 mx-auto">
                <!--mobile Intro-->
                <section class="md:hidden px-6">
                    <!--mobile Intro-->
                    <div class="mt-4 pt-6 sm:pt-10">
                        <div class="py-3 sm:py-6">
                            <p class="italic">I'm a,</p>
                            <p class="pt-1"><span class="font-bold text-3xl">Fullstack web Developer</span>.</p>
                        </div>

                        <!--mobile Profile Picture-->
                        <div class="pb-6 sm:pb-8 mt-6">
                            <img
                                ...
                                class="h-48 sm:h-60 max-h-80 min-w-fit rounded-md shadow-sm shadow-lime-600 saturate-150"
                            >

                        </div>

                        <div class="mt-5">
                            <h2 class="text-slate-200 text-xl font-bold italic">My Bio:</h2>
                        </div>

                        <div class="py-7 text-slate-300">
                            <p>A FullStack Web Developer with {{ now()->year - 2019 }} years of professional experience building client-oriented web applications.</p>

                            <p class="pt-2.5 text-lime-100 text-xs">
                                Founder/CTO at <a href="https://paperstudy.org">Paper Study</a> (2018 - 2023) <span class="px-1">|</span>
                                WordPress developer <span class="px-1">|</span>
                                Laravel Developer <span class="px-1">|</span>
                                Python dev <span class="px-1">|</span>
                                Aspiring ML engineer <span class="italic"> (Computer vision)</span>
                            </p>
                        </div>
                    </div>
                ...
                <header id="greetings" class="rounded px-6">
                    <div class="hidden md:block">
                        <div class="min-h-[80vh] grid">
                            <div class="my-auto text-5xl">
                                <p class="pb-3">I'm a </p>
                                <p class="pt-2.5"><span class="font-extrabold text-[5rem]">Fullstack Web Developer</span>.</p>
                            </div>
                        </div>


                        <div class="mt-2 grid grid-cols-3 gap-x-12 min-h-screen my-auto">
                            <!--Profile Picture-->
                            <div class="my-auto py-8">
                                <img
                                    alt="Profile Picture of Francis Njuguna"
                                    title="Full-stack Developer"
                                    src="{{ Vite::asset('resources/images/profile-pictures/profile-default.jpg') }}"
                                    class="max-h-96 rounded-sm saturate-150 shadow-md shadow-lime-600"
                                >
                                <div class="-mt-[16.5rem] -mr-4 ml-4 h-72 border-4 border-lime-500"></div>
                            </div>

                            <!--About me-->
                            <div class="col-span-2 pl-6 my-auto">
                                <h2 class="text-slate-200 text-5xl font-bold italic">Bio:</h2>

                                <p class="pt-3 pb-6 pr-5 text-lg">My name is Francis Njuguna. Am a FullStack Web Developer with {{ now()->year - 2019 }} years of professional experience building client-oriented web applications.</p>

                                <ul class="pt-4 text-lime-100 text-lg list-inside gap-y-3">
                                    <li class="flex flex-row gap-x-2">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M18 7L9.42857 17L6 13" stroke="#84cc16" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M18 7L11.767 14.2718" stroke="#ea580c" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g>
                                        </svg>
                                        <p>Founder/CTO <a href="https://paperstudy.org">Paper Study</a><span class="text-slate-400">({{ now()->year - 2018 }}) years</span></p>
                                    </li>
                                    <li class="flex flex-row gap-x-2">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M18 7L9.42857 17L6 13" stroke="#84cc16" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M18 7L11.767 14.2718" stroke="#ea580c" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g>
                                        </svg>
                                        <p>WordPress developer <span class="text-slate-400">({{ now()->year - 2019 }}) years</span></p>
                                    </li>
                                    <li class="flex flex-row gap-x-2">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M18 7L9.42857 17L6 13" stroke="#84cc16" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M18 7L11.767 14.2718" stroke="#ea580c" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g>
                                        </svg>
                                        <p>Laravel Developer <span class="text-slate-400">({{ now()->year - 2022 }}) years</span></p>
                                    </li>
                                    <li class="flex flex-row gap-x-2">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M18 7L9.42857 17L6 13" stroke="#84cc16" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M18 7L11.767 14.2718" stroke="#ea580c" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g>
                                        </svg>
                                        <p>Python dev <span class="text-slate-400">({{ now()->year - 2021 }}) years</span></p>
                                    </li>
                                    <li class="flex flex-row gap-x-2">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M21 12.1525C21 17.0389 16.9706 21 12 21C7.02944 21 3 17.0389 3 12.1525C3 7.26622 7 3.30508 12 3.30508C18 3.30508 21 8.22034 21 8.22034M21 8.22034L21 3M21 8.22034H16.3449" stroke="#a3e635" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M12 3.30508C18 3.30508 21 8.22034 21 8.22034M21 8.22034L21 3M21 8.22034H16.3449" stroke="#ea580c" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g>
                                        </svg>
                                        <p>Aspiring ML engineer <span class="italic">(Computer vision)</span></p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <!--Tech stack-->
                    <div class="mt-3 pb-6">
                        <h3 class="test-slate-200 text-lg font-semibold italic">Tech Stack</h3>
